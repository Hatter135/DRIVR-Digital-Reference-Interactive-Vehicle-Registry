...
#WARNING: you must run "pip install pygame, pillow, pyfiglet" for this program to work.
...
#music/sounds
blow_off = os.path.join(BASEDIR, "sounds/")
home_music_path = os.path.join(BASEDIR, "Sounds/Walk Through the Park - TrackTribe.wav")
Volvo_music_path = os.path.join(BASEDIR, "Sounds/A Precious Little Thing Called Love - George Olsen.wav")
Golf_music_path = os.path.join(BASEDIR, "Sounds/The Rockford Files - You Gotta Know.wav")
FocusRS_music_path = os.path.join(BASEDIR, "Sounds/Critical mass - Burning love(D-Block & S-te-Fan rmx).wav")
Skyline_GTR_music_path = os.path.join(BASEDIR, "Sounds/Wiz Khalifa - See You Again ft. Charlie Puth [Official Video] Furious 7 Soundtrack.wav")
Tesla_S_music_path = os.path.join(BASEDIR, "Sounds/Curb Your Enthusiasm Theme.wav")
Koenigsegg_Jesko_Absolut_music_path = os.path.join(BASEDIR, "Sounds/Kickstart My Heart  Eurobeat Remix.wav")
...
#menu music
pygame.mixer.music.load(home_music_path)
...
def show_volvo_specs(event:None):
        ...
        #plays the old music for volvo
        pygame.mixer.music.stop()
        pygame.mixer.music.load(Volvo_music_path)
        pygame.mixer.music.play(-1)
...
def show_golf_specs(event:None):
    ...
    #play golf music
    pygame.mixer.music.stop()
    pygame.mixer.music.load(Golf_music_path)
    pygame.mixer.music.play(-1)
...
def show_focus_specs(event:None):
    ...
    #play FocusRS music
    pygame.mixer.music.stop()
    pygame.mixer.music.load(FocusRS_music_path)
    pygame.mixer.music.play(-1)
...
# Extra images stacked horizontally under the main car
    ...
    #play Skyline_GTR music
    pygame.mixer.music.stop()
    pygame.mixer.music.load(Skyline_GTR_music_path)
    pygame.mixer.music.play(-1)
...
# Extra images stacked horizontally under the main car
    ...
    #play Tesla_S music
    pygame.mixer.music.stop()
    pygame.mixer.music.load(Tesla_S_music_path)
    pygame.mixer.music.play(-1)
...
# Extra images stacked horizontally under the main car
    ...
    #play Koenigsegg_Jesko_Absolut music
    pygame.mixer.music.stop()
    pygame.mixer.music.load(Koenigsegg_Jesko_Absolut_music_path)
    pygame.mixer.music.play(-1)
...
def back_to_home():
    ...
    #stops car music and plays menu music
    pygame.mixer.music.stop()
    pygame.mixer.music.load(home_music_path)
    pygame.mixer.music.play(-1)
